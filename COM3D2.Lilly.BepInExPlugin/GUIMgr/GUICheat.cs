...
{
    public class GUICheat : GUIMgr
    {
        public GUICheat() : base("CheatUtill")
        {
        ...
        public override void SetBody()
        {
            ...
            if (GUILayout.Button("선택 메이드 스텟, 스킬, 잡, 클래스 처리")) CheatUtill.SetMaidAll(MaidManagementMainPatch.selectMaid);
